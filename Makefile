...
lint-py:  ## run python linter with ruff
	python -m ruff check jupyter_templates
	python -m ruff format --check jupyter_templates
...
fix-py:  ## fix python formatting with ruff
	python -m ruff check --fix jupyter_templates
	python -m ruff format jupyter_templates
...
test-py:  ## run python tests
	python -m pytest -v jupyter_templates/tests

# alias
tests-py: test-py

coverage-py:  ## run python tests and collect test coverage
	python -m pytest -v jupyter_templates/tests --cov=jupyter_templates --cov-report term-missing --cov-report xml
